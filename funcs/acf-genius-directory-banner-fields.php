			...
			'fields'                => array(
				...
				array(
					...
					'sub_fields' => array(
						...
						array(
							'key'           => 'field_ftd_fsb_status',
							'label'         => 'Status text',
							'name'          => 'status_text',
							'type'          => 'text',
							'default_value' => 'Only {remaining} of {total} founding spots left.',
							'instructions'  => '{remaining} and {total} are shown bold on the front end.',
						),
						array(
							'key'           => 'field_ftd_fsb_link_text',
							'label'         => 'Link text',
							'name'          => 'link_text',
							'type'          => 'text',
							'default_value' => 'Claim a free lifetime membership with {code} →',
						),
						array(
