	...
	acf_add_local_field_group(
		array(
			...
			'fields'                => array(
				...
				array(
					'key'           => 'field_gcc_social_share_intro',
					'label'         => 'Social share intro',
					'name'          => 'social_share_intro',
					'type'          => 'textarea',
					'rows'          => 3,
					'new_lines'     => 'br',
					'instructions'  => 'Optional opening line when sharing this session. Use {title} for the session name. Times, session link and promo image are added automatically below. Leave blank for the default intro.',
					'placeholder'   => 'Join us for {title} — a Genius Network Live Session with We Are Geniuses.',
				),
				array(
					'key'           => 'field_gcc_social_share_message',
					'label'         => 'Social share message (full override)',
					'name'          => 'social_share_message',
					'type'          => 'textarea',
					'rows'          => 6,
					'new_lines'     => 'br',
					'instructions'  => 'Optional. Replace the entire share message (overrides Share intro above). Placeholders: {title}, {times}, {url}, {image}. Put {url} on its own line so the link is recognised.',
					'placeholder'   => "Join us for {title} — a Genius Network Live Session with We Are Geniuses.\n{times}\n{url}\n{image}",
				),
				array(
