...
function ftd_get_gnls_archive_defaults() {
	return array(
		...
		'sessions_title'       => 'Next Live Genius Networking Calls',
		'sessions_empty_msg' => 'No live sessions have been published yet. Check back soon — the first call details will appear here.',
		'next_steps_eyebrow'            => 'Next steps',
		'next_steps_member_heading'       => 'Genius {name}, you\'re on the list!',
		'next_steps_member_body'          => 'A Zoom link will be sent to your inbox before the call.',
		'next_steps_guest_heading'        => 'Want to join us live?',
		'next_steps_guest_body'           => 'Join the Genius Directory to receive your meeting invite for the call.',
		'next_steps_guest_button_label'   => 'Join the directory',
		'next_steps_guest_button_url'     => '',
	);
}
	...
	acf_add_local_field_group(
		array(
			...
			'fields'                => array(
				...
				array(
					'key'     => 'field_ftd_gnla_next_steps_msg',
					'label'   => '',
					'name'    => '',
					'type'    => 'message',
					'message' => 'Shown on session pages and the archive after the upcoming call. Members see the member message; everyone else sees the guest message with a join button.',
				),
				array(
					'key'           => 'field_ftd_gnla_next_steps_eyebrow',
					'label'         => 'Eyebrow label',
					'name'          => 'next_steps_eyebrow',
					'type'          => 'text',
					'default_value' => $defaults['next_steps_eyebrow'],
				),
				array(
					'key'           => 'field_ftd_gnla_next_steps_member_heading',
					'label'         => 'Member heading',
					'name'          => 'next_steps_member_heading',
					'type'          => 'text',
					'instructions'  => 'Use {name} where the member\'s first name should appear (highlighted in coral).',
					'default_value' => $defaults['next_steps_member_heading'],
				),
				array(
					'key'           => 'field_ftd_gnla_next_steps_member_body',
					'label'         => 'Member message',
					'name'          => 'next_steps_member_body',
					'type'          => 'textarea',
					'rows'          => 3,
					'default_value' => $defaults['next_steps_member_body'],
				),
				array(
					'key'           => 'field_ftd_gnla_next_steps_guest_heading',
					'label'         => 'Guest heading',
					'name'          => 'next_steps_guest_heading',
					'type'          => 'text',
					'default_value' => $defaults['next_steps_guest_heading'],
				),
				array(
					'key'           => 'field_ftd_gnla_next_steps_guest_body',
					'label'         => 'Guest message',
					'name'          => 'next_steps_guest_body',
					'type'          => 'textarea',
					'rows'          => 4,
					'default_value' => $defaults['next_steps_guest_body'],
				),
				array(
					'key'           => 'field_ftd_gnla_next_steps_guest_button_label',
					'label'         => 'Guest button label',
					'name'          => 'next_steps_guest_button_label',
					'type'          => 'text',
					'default_value' => $defaults['next_steps_guest_button_label'],
				),
				array(
					'key'           => 'field_ftd_gnla_next_steps_guest_button_url',
					'label'         => 'Guest button URL',
					'name'          => 'next_steps_guest_button_url',
					'type'          => 'url',
					'instructions'  => 'Leave blank to use the directory join URL from banner settings.',
					'default_value' => $defaults['next_steps_guest_button_url'],
				),
			),
			'location'              => array(
				array(
